...
const copyTerraform = async (id: string, variant: string) => {
    const ref = await getLatestRef()
    copyVariant(terraformSnippet(id, ref), variant)
}
</script>
