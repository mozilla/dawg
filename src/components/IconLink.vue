...
<template>
    <a :href="props.href">
        <template v-if="props.href.includes('github.com')">
            <!-- GitHub SVG -->
        ...
        <template v-else-if="props.href.includes('mozilla-hub.atlassian.net')">
            <!-- Jira SVG -->
            <img :src="jiraLogo" width="25px" height="25px" alt="Jira Logo" />
        </template>
        <!-- TODO: Add internal link icon -->
        <template v-else>
            <!-- Outbound Link SVG -->
            <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="Interface / External_Link">
                    <path id="Vector"
                        ...
                        class="stroke-current text-blue-600 dark:text-blue-300" stroke-width="2" stroke-linecap="round"
